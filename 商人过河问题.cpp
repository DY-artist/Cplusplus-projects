...
int main()
{
	...
	//a1.pcon.push_back(&a2);
	//a2.pcon.push_back(&a3);
	//a2.pcon.push_back(&a4);
	//a2.pcon.push_back(&a5);
	//a3.pcon.push_back(&a2);
	//a3.pcon.push_back(&a4);
	//a3.pcon.push_back(&a6);
	//a4.pcon.push_back(&a2);
	//a4.pcon.push_back(&a3);
	//a4.pcon.push_back(&a6);
	//a4.pcon.push_back(&a5);
	//a5.pcon.push_back(&a2);
	//a5.pcon.push_back(&a4);
	//a5.pcon.push_back(&a6);
	//a6.pcon.push_back(&a3);
	//a6.pcon.push_back(&a4);
	//a6.pcon.push_back(&a5);
	//a6.pcon.push_back(&a7);
	//a7.pcon.push_back(&a6);
	//vvcondi result = search_net(a1,a4);
